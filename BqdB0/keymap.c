...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TAB,         UC_OSLS,        UC_ETH,         UC_AE,          UC_ARNG,        KC_T,                                           KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           IS_22,          
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LCTL, KC_A),MT(MOD_LALT, KC_S),KC_D,           MT(MOD_LSFT, KC_F),KC_TRANSPARENT,                                 KC_TRANSPARENT, MT(MOD_RSFT, KC_J),KC_K,           MT(MOD_RALT, KC_L),MT(MOD_RCTL, IS_21),KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
